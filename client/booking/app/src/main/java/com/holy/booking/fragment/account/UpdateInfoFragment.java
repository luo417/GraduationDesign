...
import com.holy.factory.presenter.user.UpdateInfoContract;
import com.holy.factory.presenter.user.UpdateInfoPresenter;
...
public class UpdateInfoFragment extends PresenterFragment<UpdateInfoContract.Presenter>
    ...
    void onSubmitClick() {
        // 调用P层进行注册
        mPresenter.update(mPortraitPath, isMan);
    }
